...
(use-package dashboard
  ...
  (setq dashboard-footer-messages '("Welcome to Emacs Dashboard!"))
...
(use-package helm-projectile
  ...
  ;; ;; Install any additional Helm-related packages you might need
  ;; ;; (e.g., helm-ag, helm-git-grep, etc.)

(use-package helm-posframe
  :load-path "~/helm-postframe"
  :demand t
  :config
  (helm-posframe-enable))
;; Customize helm-posframe appearance
(setq helm-posframe-parameters
      '((left-fringe . 8)   ; Adjust left-fringe value to make the Posframe narrower
        (right-fringe . 8))) ; Adjust right-fringe value to make the Posframe narrower
