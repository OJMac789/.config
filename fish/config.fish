...
abbr -a -g ff 'firefox'																								#
abbr -a -g pac 'sudo pacman -Syu --noconfirm'
abbr -a -g ra 'ranger'
abbr -a -g mb 'mbsync -a && mu index'
abbr -a -g inst 'sudo pacman -S'
abbr -a -g sear 'pacman -Ss'
abbr -a -g dmu '~/.config/emacs/bin/doom upgrade'
abbr -a -g dms '~/.config/emacs/bin/doom sync'
abbr -a -g dmp '~/.config/emacs/bin/doom purge'
abbr -a -g dmi '~/.config/emacs/bin/doom install'
abbr -a -g rb 'sudo reboot'
abbr -a -g hey 'sudo pacman -Syu --noconfirm && paru -Syu --noconfirm && mbsync -a && mu index && exit'
abbr -a -g wf 'wofipassmenu'
abbr -a -g vv 'nvim'
abbr -a -g lg 'lazygit'
abbr -a -g lg 'lazygit'
...
# Created by `pipx` on 2023-07-08 02:31:42
set PATH $PATH /home/oliver/.local/bin
set -x PATH ~/.config/emacs/bin $PATH
set -x PASH_KEYID ojandjess1@gmail.com
set -x PM_GPG_USER ojandjess1@gmail.com
set -x PATH /path/to/poetry/bin $PATH
set -x PATH /path/to/conda/bin $PATH
set -x PATH /path/to/pyenv/bin $PATH
